...
$(function(){
	...
	$("#ex1 > thead > tr > th").click(function() {
							...
							<thead>
								<tr>
									...
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
										class="textSm primary"><b> 完赛</b></th>
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
										class="textSm primary"><b>胜</b></th>
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
										class="textSm primary"><b> 平</b></th>
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
										class="textSm primary"><b> 负</b></th>
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
										class="textSm primary"><b> 进球</b></th>
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
										class="textSm primary"><b> 失球</b></th>
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
										class="textSm primary"><b> 净胜球</b></th>
									<th width="24" align="center" nowrap="nowrap" bgcolor="#cccccc"
										class="textSm primary">积分</th>
									<th width="24" nowrap="nowrap" bgcolor="#cccccc" align="center"
